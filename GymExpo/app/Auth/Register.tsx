  ...
  return (
    ...
    >
      <KeyboardAvoidingView
        ...
        keyboardVerticalOffset={Platform.OS === 'ios' ? 60 : 0} // pas eventueel aan
      >
          ...
          >
            <View style={styles.contentContainer}>
              <View style={styles.buttonContainer}>
                ...
                <Pressable style={[styles.btn, styles.registerBtn]} onPress={handleRegister}>
...
const styles = StyleSheet.create({
  ...
  registerBtn: { backgroundColor: '#3A9ADA' },
  buttonContainer: {
